...
if not GEMINI_API_KEY:
    raise ValueError("GEMINI_API_KEY environment variable is not set. "
                      "Set it in Render's dashboard (Environment tab) or "
                      "in your terminal before running locally.")
...
CHUNK_SIZE = 700
CHUNK_OVERLAP = 100
PORT = int(os.environ.get("PORT", 5000))  # Render assigns its own port via this env var
